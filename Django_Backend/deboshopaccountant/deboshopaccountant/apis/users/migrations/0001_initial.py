    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_employee_user_name', models.CharField(max_length=256, unique=True, verbose_name='Nombre de Usuario')),
                ('user_employee_password', models.CharField(max_length=16, verbose_name='Contraseña')),
                ('user_employee_login', models.BooleanField(blank=True, verbose_name='Logueado')),
                ('user_employee_status', models.CharField(blank=True, max_length=50, verbose_name='Estado')),
                ('user_employee_status_description', models.CharField(default='Ninguna', max_length=256, verbose_name='Descripción')),
                ('user_employee_create_at', models.DateTimeField(blank=True, verbose_name='Fecha de Creación')),
                ('user_employee_update_at', models.DateTimeField(blank=True, null=True, verbose_name='Fecha de Actualización')),
                ('is_staff', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=False)),
                ('fk_employee', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='employees.employeemodel')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('fk_user_level', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='users.userlevelmodel')),
            ],
            options={
