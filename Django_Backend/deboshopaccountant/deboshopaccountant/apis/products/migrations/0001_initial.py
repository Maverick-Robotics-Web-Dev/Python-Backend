    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.brandmodel')),
                ('fk_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.categorymodel')),
            ],
            options={
