...
class OwnCheckModel(models.Model):
    own_check_id = models.AutoField('ID', primary_key=True)
    ...
    own_check_voucher_type = models.CharField(
        'Tipo de Comprobante', max_length=50)
    own_check_voucher_number = models.CharField(
        'Numero de Comprobante', max_length=100, blank=True, null=True)
    own_check_deposit_date = models.DateField('Fecha de Deposito')
    own_check_bank = models.CharField('Banco', max_length=256)
    own_check_account_number = models.CharField(
    ...
    own_check_upgrade_at = models.DateTimeField(
