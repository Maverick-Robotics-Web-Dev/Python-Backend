...
from .serializers import (
    SupplierSerializer,
    SupplierRelatedSerializer,
    IncomeSerializer,
    IncomeRelatedSerializer,
    IncomeDetailSerializer,
    IncomeDetailRelatedSerializer
)


class SupplierViewSet(MultiSerializerViewSet):

    model = SupplierModel
    serializers: dict = None
    obj: SupplierModel = None
    ...
    serializers = {
        ...
        'list': SupplierRelatedSerializer,
        'retrieve': SupplierRelatedSerializer
    }

    def get_object(self: Self, pk: str) -> SupplierModel:
...
class IncomeViewSet(MultiSerializerViewSet):

    model = IncomeModel
    serializers: dict = None
    obj: IncomeModel = None
    query_res: QuerySet = None
    serializer: Serializer = None
    data: dict = None
    response_error: ValidationError = None
    ...
    model = IncomeModel
    serializers = {
        'default': IncomeSerializer,
        'list': IncomeRelatedSerializer,
        'retrieve': IncomeRelatedSerializer
    }

    def get_object(self: Self, pk: str) -> IncomeModel:
...
class IncomeDetailViewSet(MultiSerializerViewSet):

    model = IncomeDetailModel
    serializers: dict = None
    obj: IncomeDetailModel = None
    query_res: QuerySet = None
    serializer: Serializer = None
    data: dict = None
    response_error: ValidationError = None
    ...
    model = IncomeDetailModel
    serializers = {
        'default': IncomeDetailSerializer,
        'list': IncomeDetailRelatedSerializer,
        'retrieve': IncomeDetailRelatedSerializer
    }

    def get_object(self: Self, pk: str) -> IncomeDetailModel:
