...
class EmployeeModel(PersonModel):
    employee_id = models.AutoField('ID', primary_key=True)
    ...
    employee_contract_type = models.CharField(
        'Tipo de Contrato', max_length=256, default='No posee contrato')
    employee_contract_code = models.CharField(
        'Codigo de Contrato', max_length=256, default='No posee codigo')
    employee_admission_date = models.DateField('Fecha de Ingreso')
    employee_departure_date = models.DateField(
        'Fecha de Salida', blank=True, null=True)
    employee_departament = models.CharField(
        'Area o Departamento', max_length=256)
    employee_position = models.CharField('Cargo', max_length=256)
    employee_extension_number = models.CharField(
        'Numero de Extensión', max_length=50, default='No Posee Extensión')
    ...
    employee_upgrade_at = models.DateTimeField(
        'Fecha Actualización', blank=True, null=True)
