...
from .serializers import (
    EmployeeSerializer,
    EmployeeRelatedSerializer
)


class EmployeeViewSet(MultiSerializerViewSet):

    model = EmployeeModel
    serializers: dict = None
    obj: EmployeeModel = None
    ...
    serializers = {
        ...
        'list': EmployeeRelatedSerializer,
        'retrieve': EmployeeRelatedSerializer
    }

    def get_object(self: Self, pk: str) -> EmployeeModel:
