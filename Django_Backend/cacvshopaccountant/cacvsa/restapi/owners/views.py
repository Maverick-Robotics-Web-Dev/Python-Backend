...
from .serializers import (
    OwnCheckSerializer,
    OwnCheckRelatedSerializer
)


class OwnCheckViewSet(MultiSerializerViewSet):

    model = OwnCheckModel
    serializers: dict = None
    obj: OwnCheckModel = None
    ...
    model = OwnCheckModel
    serializers = {
        'default': OwnCheckSerializer,
        'list': OwnCheckRelatedSerializer,
        'retrieve': OwnCheckRelatedSerializer
    }

    def get_object(self: Self, pk: str) -> OwnCheckModel:
