...
class CategoryModel(models.Model):
    ...
    category_update_at = models.DateTimeField(
...
class BrandModel(models.Model):
    ...
    brand_update_at = models.DateTimeField(
        'Fecha de Actualización', blank=True, null=True)
...
class ProductModel(models.Model):
    ...
    product_barcode = models.CharField(
        'Codigo de Barras', max_length=13, default='No posee codigo')
    ...
    product_number_sale = models.PositiveBigIntegerField(
        'Numero de Ventas', default=0)
    product_img = models.CharField('Imagen', max_length=256)
    product_due_date = models.DateField(
    ...
    fk_category = models.ForeignKey(
        'products.CategoryModel', on_delete=models.CASCADE, verbose_name='Categoria')
    fk_brand = models.ForeignKey(
        'products.BrandModel', on_delete=models.CASCADE, verbose_name='Marca')
    ...
    product_update_at = models.DateTimeField(
        'Fecha de Actualización', blank=True, null=True)
