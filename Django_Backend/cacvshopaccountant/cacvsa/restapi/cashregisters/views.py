...
class CashRegisterMovementsViewSet(MultiSerializerViewSet):
    ...
    serializers: dict = None
    obj: CashRegisterMovementsModel = None
    query_res: QuerySet = None
    serializer: Serializer = None
    data: dict = None
    response_error: ValidationError = None
    ...
    model = CashRegisterMovementsModel
    serializers = {
        'default': CashRegisterMovementsSerializer,
        'list': CashRegisterMovementsRelatedSerializer,
        'retrieve': CashRegisterMovementsRelatedSerializer
    }

    def get_object(self: Self, pk: str) -> CashRegisterMovementsModel:
...
class CashRegisterClosingViewSet(MultiSerializerViewSet):
    ...
    serializers: dict = None
    obj: CashRegisterClosingModel = None
    query_res: QuerySet = None
    serializer: Serializer = None
    data: dict = None
    response_error: ValidationError = None
    ...
    model = CashRegisterClosingModel
    serializers = {
        'default': CashRegisterClosingSerializer,
        'list': CashRegisterClosingRelatedSerializer,
        'retrieve': CashRegisterClosingRelatedSerializer
    }

    def get_object(self: Self, pk: str) -> CashRegisterClosingModel:
