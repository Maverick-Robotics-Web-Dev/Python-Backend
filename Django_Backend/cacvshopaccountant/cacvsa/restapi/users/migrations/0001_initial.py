    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_employee_login', models.BooleanField(blank=True, default=False, null=True, verbose_name='Logueado')),
                ('user_employee_status', models.BooleanField(blank=True, default=False, max_length=50, null=True, verbose_name='Estado')),
